...
const photoTimeline = ref(undefined as SelectOption<App.Enum.TimelinePhotoGranularity> | undefined);
const albumTimeline = ref(undefined as SelectOption<App.Enum.TimelineAlbumGranularity> | undefined);
